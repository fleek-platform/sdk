...
describe('[Node.js] DomainsClient', () => {
  ...
  it('should delete domain', async (context) => {
    const response = await context.sdks.josh.domains().deleteDomain({
      domainId: seeds.domains.domain.electronicCoPrimary.zoneId,
    });
...
describe.skip('[Chromium] DomainsClient', () => {
