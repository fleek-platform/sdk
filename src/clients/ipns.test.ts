...
const TEST_KEY = 'k51qzi5uqu5djd7wik4gj3evcbnx2okerdrh0swusu07mu2ak1v1r3y70e7k8o';
const TEST_INPUT =
...
describe('[Node.js] IpnsClient', async () => {
  ...
  // for some reason
  it.skip('should get resolved IPNS name', async (context) => {
    const response = await context.sdks.josh.ipns().resolveName({ name: TEST_KEY });
...
describe.skip('[Chromium] IpnsClient', async () => {
